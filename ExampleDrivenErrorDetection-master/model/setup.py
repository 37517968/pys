...
setup(
    ...
    # install_requires=['setuptools>=36','urllib3==1.21.1', 'matplotlib', 'numpy', 'pandas', 'scikit-learn', 'xgboost', 'seaborn', 'graphviz', 'jinja2', 'scipy', 'eli5', 'psycopg2', 'keras', 'tensorflow', 'usaddress', 'gensim==3.8.3'],
