...
class DataSet(DataSetBasic):
    ...
    def __init__(self, name, dirty_pd, clean_pd, train_indices=None, test_indices=None):
        ...
        super(DataSet, self).__init__(name, dirty_pd, matrix_is_error, train_indices, test_indices)