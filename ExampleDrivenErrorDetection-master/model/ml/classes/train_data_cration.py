...
def run_in_cllm_env(module_path, func_name, *args, **kwargs):
    ...
    **kwargs: 函数的关键字参数
    ...
    script_lines = [
        ...
        "sys.path.append('/home/stu/pys/CLLM-main/src')",  # 更新为实际路径
...
def create_original_train_data(dirty_df, clean_df, train_number=200, cluster_number=5):
    """
    使用聚类方法从数据集中创建训练数据
    ...
    #     save_path = "/home/stu/pys/ExampleDrivenErrorDetection-master/datasets/HOSP_HoloClean/error.csv"
    # )
    # ontology_df = run_in_cllm_env(
    #     'error_detection.llm_aug',
    #     'analyse_table_ontology',
    #     clean_representative,
    #     save_path = "/home/stu/pys/ExampleDrivenErrorDetection-master/datasets/HOSP_HoloClean/ontology.csv"
    # )
    ...
    #     save_path = "/home/stu/pys/ExampleDrivenErrorDetection-master/datasets/HOSP_HoloClean/enhanced_data/enhanced_clean.csv",
    #     number=200,
    # )
    ...
    #     batch_size=20,
    #     save_path="/home/stu/pys/ExampleDrivenErrorDetection-master/datasets/HOSP_HoloClean/enhanced_data/enhanced_dirty.csv",
    # )
    ontology_df = pd.read_csv("/home/stu/pys/ExampleDrivenErrorDetection-master/datasets/HOSP_HoloClean/ontology.csv")
    error_analysis = pd.read_csv("/home/stu/pys/ExampleDrivenErrorDetection-master/datasets/HOSP_HoloClean/error.csv")
    enhanced_dirty_df = pd.read_csv("/home/stu/pys/ExampleDrivenErrorDetection-master/datasets/HOSP_HoloClean/enhanced_data/enhanced_dirty.csv")
    enhanced_clean_df = pd.read_csv("/home/stu/pys/ExampleDrivenErrorDetection-master/datasets/HOSP_HoloClean/enhanced_data/enhanced_clean.csv")
...
def create_next_train_data(dirty_df, clean_df, all_error_pred, ontology_df, error_analysis, train_number=200, example_number=5):
    ...
    example_dirty_df = dirty_df.iloc[uncertain_indices].reset_index(drop=True)
    example_clean_df = clean_df.iloc[uncertain_indices].reset_index(drop=True)
    error_analysis = run_in_cllm_env(
        'error_detection.llm_aug',
